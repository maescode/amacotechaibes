                    ...
                    <div class="content content-full">
                        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                            <h1 class="flex-sm-fill h3 my-2">
                                <font face="candara">EDIT ARTICLEs</font>
                            </h1>
...
if(isset($_POST['submitBlogs'])){
 ...
 $query = mysqli_query($con,"UPDATE article set title='".$title."',author='".$author."',date_created='".$date_created."',entry_text='".$entry_text."',image='".$filepath."' where id='".$id."'")
