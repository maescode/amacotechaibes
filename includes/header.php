...
<div class="clv_header" id="header">
		<div class="container">
			<div class="row"> 
				<div class="col-lg-1 col-md-1">
					<div class="clv_left_header">
						<div class="clv_logo text-center">
							<a href="index.php"><img src="images/logo.png" alt="Cultivation" width="100px" class="ml-4" /><h3 class="text-success font-weight-bold">AMACOTECH</h3></a>
						</div>
					</div>
				</div>
				<div class="col-lg-11 col-md-11">
					<div class="clv_right_header">
							...
							<div class="row">
								<div class="col-md-5">
									<div class="address_block">
										...
										<div class="header_location">
											<h5>Our location</h5>
											<p>
											 No 6a/3051 Adeboye House, Sango-Eleyele express Road, Alabama bus stop, Ibadan, Oyo state, Nigeria. 
                            				</p>
										</div>
									</div>
								</div>
								<div class="col-md-3">
									<div class="address_block">
										...
										<div class="header_location">
											<h5>24/7 in touch</h5>
											<p><a href="tel:+2348076465550">( +234 ) 8076465550</a></p>
											<p> <a href="tel:+2348064171276">( +234 ) 8064171276</a></p>
										</div>
									</div>
								</div>
								<div class="col-md-4">
									<div class="address_block br_none">
										...
										<div class="header_location">
											<h5>email address</h5>
											<p><a href="mailto:info@amacotechaibes.com">info@amacotechaibes.com</a></p>
										</div> 
									</div>
								</div>
							</div>
						...
						<div class="clv_menu">
								...
								<ul>
									...
									<li >
									   <a href="javascript:;">Our services</a>
											<ul>
												<li><a href="./food-production-processing.php">Food Production & Processing</a></li>
												<li><a href="./ict-and-multimedia.php">ICT & Multimedia</a></li>
												<li><a href="./career_education.php">Career Education</a></li>
												<li><a href="./trainings.php">Trainings</a></li>
												<li><a href="./publications.php">Publications</a></li>
												<li><a href="./stage_lighting_and_event.php">Stage Lighting & Event</a></li>
												<li><a href="faq.php">FAQ</a></li>
											</ul>
									</li>
									<li><a href="./career_education.php">Career</a></li>
									<li><a href="partners.php">Partners</a></li>
									<li><a href="subscription-plan.php">Subscription</a></li>
									<li><a href="gallery.php">gallery</a></li>
									<li><a href="contact-us.php">contact</a></li>
									<li><a href="blogs.php">New</a></li>
									<li><a href="shop/index.php">Our Shop</a></li>		
								</ul>
							</div>
							<div class="cart_nav">
								<ul>
							...
							<a href="shop/index.php" class="appointment_btn">Our Shop</a>
						</div>
					</div>
				</div>
			</div>
