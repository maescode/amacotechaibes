...
<!-- Begin Head --> 
<head>
		<title>AMACOTECH INTEGRATED BUSINESS AND EVENT SERVICES (AIBES) –  Training</title>
					...
					<div class="col-lg-6 col-md-6">
						<div class="service_content">
							<div class="service_heading">
								<h3 class="font-weight-bold text-dark" >Training</h3>
								<hr class="bg-light">
								<!-- Add Arrows -->
							...
							<p>
								The Training unit empowers and equips team members, workers, youths and students with various practical and vocational skills and knowledge in the areas of French language, music, electronics, food processing, etc.
							</p>
							...
							<div class="swiper-container">
								<div class="swiper-wrapper">
									<div class="swiper-slide">
										<div class="dairy_service_slide"><img src="images/training.jpg" alt="image" style="width: 574px" /></div>
									</div>
							    
									<div class="swiper-slide">
										<div class="dairy_service_slide"><img src="images/stacking tomatoes 1.jpg" alt="image" style="width: 574px" /></div>
									</div>
								</div>
							</div>
						</div>
