...
if(isset($_POST['submitBlogs'])){
 ...
 $query = mysqli_query($con,"INSERT into blog (title,author,date_created,entry_text,image) VALUES ('$title','$author','$date_created','$entry_text','$filepath')")
...
?>
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        <div class="form-group form-row">
                                            <div class="col-9">
                                                <label>Title</label>
                                                <input type="text" name="title" class="form-control" placeholder="News Title" value="<?php echo isset($_POST['title']) ? $_POST['title'] : '' ?>" required>
                                            </div>
                                            <div class="col-3">
                                                <label>Author</label>
                                                <input type="text" name="author" class="form-control" placeholder="News Author" value="<?php echo isset($_POST['author']) ? $_POST['author'] : '' ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group form-row">
                                            <div class="col-6">
...
<br>
             <!-- Dynamic Table Full Pagination -->
                    <div class="table-responsive block block-rounded">
                        <div class="block-header">
                            <h3><font face="candara">PUBLISHED NEWS</font></h3>
                        </div>
          ...
          while($row = mysqli_fetch_array($result)) {
             echo" <tr>
                ...
                <td><a href=deleteblogs.php?id={$row['id']}>
          <i class='fa fa-trash'></i></a> &nbsp;&nbsp;&nbsp; <a href=editblogs.php?id={$row['id']}><i class='fa fa-edit'></i></a></td> 
              </tr>";
                                     }
                                     ?>
