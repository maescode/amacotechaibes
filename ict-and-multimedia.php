...
<!-- Begin Head --> 
<head>
		<title>AMACOTECH INTEGRATED BUSINESS AND EVENT SERVICES (AIBES) –  ICT and Multimedia</title>
		...
		<div class="breadcrumb_wrapper">
				...
				<div class="row justify-content-center">
					<div class="col-md-4">
						<div class="breadcrumb_inner">
							<h3>Amacotech ICT & Multimedia</h3>
						</div>
					</div>
				</div>
			</div>
			<div class="breadcrumb_block">
				<ul>
					...
					<li>Amacotech ICT & Multimedia</li>
				</ul>
			</div>
		</div>
				...
				<div class="col-lg-6 col-md-6">
					<div class="service_content">
						<div class="service_heading">
							<h3 class="font-weight-bold text-dark" >ICT & Multimedia</h3>
							<hr class="bg-light">
							<!-- Add Arrows -->
						...
						<p>
							 Our ICT and multimedia unit takes you through an array of soft and hard skills under experienced mentoring. Here, we equip all candidates with the necessary knowledge and skills the modern Labour market requires for them to succeed. Knowledge and skills are readily available for those who are interested in web development, graphic design, sound engineering, videography, stage lighting design, programming and control, developing and using software in data anaysis and presentations etc.
						</p>
						...
						<div class="swiper-container">
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<div class="dairy_service_slide"><img src="images/ict_mult.jpeg" alt="image"  style="width: 574px"/></div>
								</div>
