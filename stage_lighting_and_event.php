...
<!-- Begin Head --> 
<head>
		<title>AMACOTECH INTEGRATED BUSINESS AND EVENT SERVICES (AIBES) –  STAGE LIGHTING & EVENT</title>
		...
		<div class="breadcrumb_wrapper">
				...
				<div class="row justify-content-center">
					<div class="col-md-4">
						<div class="breadcrumb_inner pt-5">
							<h3>Stage Lighting and Event</h3>
						</div>
					</div>
				</div>
			</div>
			<div class="breadcrumb_block">
				<ul>
					...
					<li>Stage Lighting and Event</li>
				</ul>
			</div>
		</div>
					...
					<div class="col-lg-6 col-md-6">
						<div class="service_content">
							<div class="service_heading">
								<h3 class="font-weight-bold text-dark" >Stage Lighting And Event</h3>
								<hr class="bg-light">
								<!-- Add Arrows -->
							...
							<p>
								...
								The stage lighting and event unit specializes in stage and event management using portal floor, stage lighting, stage, sound, fireworks, truss, etc to animate and make our clients' events colourful and memorable. In addition, we train, maintain, service and repair all kinds of stage lighting fixtures, such as moving heads lights, non-moving head lights, smoke machines, follow spot, screens, etc.
							</p>
							...
							<div class="swiper-container">
								<div class="swiper-wrapper">
									<div class="swiper-slide">
										<div class="dairy_service_slide"><img src="images/stage and lightnig.jpeg" alt="image" style="width: 574px" /></div>
									</div>
