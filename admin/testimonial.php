...
if(isset($_POST['submit'])){
 ...
 $check="SELECT * FROM testimonial WHERE name = '$_POST[name]'";
 ...
 $query = mysqli_query($con,"INSERT into testimonial (name,portfolio,testimony) VALUES ('$name','$portfolio','$testimony')")
...
?></center>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="example-text-input" name="name" placeholder="Event Title" value="<?php echo isset($_POST['name']) ? $_POST['name'] : '' ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="example-email-input">Portfolio</label>
                                            <input type="text" class="form-control" id="example-email-input" name="portfolio" placeholder="Portfolio" value="<?php echo isset($_POST['portfolio']) ? $_POST['portfolio'] : '' ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="example-textarea-input">Testimony</label>
                                            <textarea class="form-control" id="example-textarea-input" name="testimony" rows="4" placeholder="Testimonial" required><?php echo isset($_POST['testimony']) ? $_POST['testimony'] : '' ?></textarea>
                                        </div>
                    ...
                    <div class="table-responsive block block-rounded">
                        <div class="block-header">
                            <h3><font face="candara">PUBLISHED TESTIMONIAL</font></h3>
                        </div>
                        <div class="block-content block-content-full">
          ...
          while($row = mysqli_fetch_array($result)) {
             echo" <tr>
                ...
                <td>" . $row['testimony'] . "</td>
                <td><a href=deletetestimonial.php?id={$row['id']}>
          <i class='fa fa-trash'></i></a> &nbsp;&nbsp;&nbsp; <a href=edittestimonial.php?id={$row['id']}><i class='fa fa-edit'></i></a></td> 
              </tr>";
             }
             ?>
