                                ...
                                <div class="row push">
                                    <div class="col-lg-4">
                                        <p class="font-size-sm text-muted">
                                            <h6 align="right"><font face="candara">The panel is where you add new people as ADMINs. They all have exclusive access to the ADMIN module, just as you do.</font></h6>
                                        </p>
                                    </div>
...
$check = mysqli_query($con, "SELECT * FROM admin where username = '$_POST[username]'");
...
?></center>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="example-text-input" name="username" placeholder="Username" value="<?php echo isset($_POST['username']) ? $_POST['username'] : '' ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="example-email-input">Password</label>
                                            <input type="text" class="form-control" id="example-email-input" name="password" placeholder="Password" value="<?php echo isset($_POST['password']) ? $_POST['password'] : '' ?>" required>
                                        </div>
                    ...
                    <div class="table-responsive block block-rounded">
                        <div class="block-header">
                            <h3><font face="candara">PUBLISHED ADMINs</font></h3>
                        </div>
                        <div class="block-content block-content-full">
          ...
          while($row = mysqli_fetch_array($result)) {
             echo" <tr>
                ...
                <td>" . $row['id'] . "</td>
                <td>" . $row['username'] . "</td>               
                <td><a href=deleteadmin.php?id={$row['id']}>
