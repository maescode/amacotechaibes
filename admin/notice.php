                    ...
                    <div class="content content-full">
                        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                            <h1 class="flex-sm-fill h3 my-2">
                                <font face="candara">NOTICEs</font> 
                            </h1>
                        </div>
                    </div>
                </div>
...
if(isset($_POST['submit'])){
 ...
 $check="SELECT * FROM upcoming WHERE title = '$_POST[title]' and from_date = '$_POST[from_date]'";
 ...
 $query = mysqli_query($con,"INSERT into upcoming (title,description,from_date,to_date,venue) VALUES ('$title','$description','$from_date','$to_date','$venue')")
...
?></center>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="example-email-input" name="from_date" placeholder="Event Start Date" value="<?php echo isset($_POST['from_date']) ? $_POST['from_date'] : '' ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="example-password-input">Ending Date</label>
                                            <input type="text" class="form-control" id="example-password-input" name="to_date" placeholder="Event End Date" value="<?php echo isset($_POST['to_date']) ? $_POST['to_date'] : '' ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="example-password-input">Venue</label>
                                            <input type="text" class="form-control" id="example-password-input" name="venue" placeholder="Event Venue" value="<?php echo isset($_POST['venue']) ? $_POST['venue'] : '' ?>" required>
                                        </div>
                                        <div class="form-group">
                    ...
                    <div class="table-responsive block block-rounded">
                        <div class="block-header">
                            <h3><font face="candara">PUBLISHED NOTICES</font></h3>
                        </div>
                        <div class="block-content block-content-full">
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                ...
                                <tbody>
                                    <?php 
          $result = mysqli_query($con, "SELECT * FROM upcoming");
          while($row = mysqli_fetch_array($result)) {
             echo" <tr>
                ...
                <td>" . $row['venue'] . "</td>               
                <td><a href=deletenotice.php?id={$row['id']}>
          <i class='fa fa-trash'></i></a> &nbsp;&nbsp;&nbsp; <a href=editnotice.php?id={$row['id']}><i class='fa fa-edit'></i></a></td> 
              </tr>";
                                     }
                                     ?>
